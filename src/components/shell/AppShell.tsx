      ...
      <div className="mt-auto flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <span className="flex items-center gap-1">
            {SITE.githubUrl && (
              <a href={SITE.githubUrl} target="_blank" rel="noopener noreferrer" aria-label="GitHub repository" className={buttonClass('ghost', 'icon', 'size-8')}>
                <IconGitHub className="size-4" />
              </a>
            )}
            {SITE.xUrl && (
              <a href={SITE.xUrl} target="_blank" rel="noopener noreferrer" aria-label="Follow on X" className={buttonClass('ghost', 'icon', 'size-8')}>
